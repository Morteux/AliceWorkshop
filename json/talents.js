const talents = {
    "Arlecchino": {
        ...
        "combat2": {
            "name": "All is Ash",
            "descriptionRaw": "Summons forth Balemoon Bloodfire, dealing <color=#FF9999FF>Pyro DMG</color> to multiple nearby opponents and performing a dash-cleave against one of them, dealing <color=#FF9999FF>AoE Pyro DMG</color>. Opponents hit by the aforementioned attack will have a Blood-Debt Directive applied to them. After the dash-cleave, Arlecchino's Bond of Life will be cleared, and Nourishing Cinders will trigger: Arlecchino recovers HP equivalent to 200% of the value of the Life Bond that was cleared. \n \n  <color=#FF9999FF>Blood-Debt Directive</color>  Lasts 30s. Every 3s, it will deal 1 instance of <color=#FF9999FF>Pyro DMG</color> to the opponent. Max 3 instances.· When Arlecchino uses a Charged Attack, she will absorb and clear nearby Blood-Debt Directives that she applied. Each Directive absorbed grants her a Bond of Life worth 20% of her Max HP.· The maximum value of the Bond of Life she can be granted through this method within 20s after using her Elemental Skill is 80% of her Max HP.<i>As she sees it, not every grain of wheat that falls upon the earth will grow into an ear, while those who obstruct her, once burned to ashes, can certainly be used to nourish flowers.</i>",
