const talents = {
    ...
    "Sigewinne": {
        ...
        "combat1": {
            ...
            "descriptionRaw": "Normal Attack: Performs up to 3 consecutive attacks with a bow. Charged Attack Performs a more precise Aimed Shot with increased DMG. While aiming, the power of Hydro will continually accumulate on the arrow. After fully charging, Sigewinne will periodically fire slow-moving Mini-Stration Bubbles toward the target, dealing Hydro DMG. When released, an arrow imbued with torrential energy will deal Hydro DMG to the opponent hit. Plunging Attack Fires off a shower of arrows in mid-air before falling and striking the ground, dealing AoE DMG upon impact.",
            "description": "Normal Attack: Performs up to 3 consecutive attacks with a bow. Charged Attack Performs a more precise Aimed Shot with increased DMG. While aiming, the power of Hydro will continually accumulate on the arrow. After fully charging, Sigewinne will periodically fire slow-moving Mini-Stration Bubbles toward the target, dealing Hydro DMG. When released, an arrow imbued with torrential energy will deal Hydro DMG to the opponent hit. Plunging Attack Fires off a shower of arrows in mid-air before falling and striking the ground, dealing AoE DMG upon impact.",
            "attributes": {
                "labels": [
                ],
                "parameters": {
        ...
        "combat3": {
            "name": "Q. Super Saturated Syringing",
            "descriptionRaw": "Burst Skill: Take out a special Fortress of Meropide-made syringe and assault the area in front with waves of kindness and medicine, dealing AoE Hydro DMG. In addition, Sigewinne absorb up to 2 nearby Sourcewater Droplets within a certain range right before using the skill.",
            "description": "Burst Skill: Take out a special Fortress of Meropide-made syringe and assault the area in front with waves of kindness and medicine, dealing AoE Hydro DMG. In addition, Sigewinne absorb up to 2 nearby Sourcewater Droplets within a certain range right before using the skill.",
            "attributes": {
                "labels": [
                ],
                "parameters": {
