const talents = {
    "Arlecchino": {
        ...
        "combat1": {
            ...
            "descriptionRaw": "<color=#FFD780FF>Normal Attack</color>\nPerforms a maximum of 6 consecutive strikes.\n\n<color=#FFD780FF>Charged Attack</color>\nConsumes a fixed amount of Stamina, dashing toward a nearby opponent and cleaving once. Continuously holding this button will cause Arlecchino to consume Stamina and engage in up to 3s of high-speed movement.\n\n<color=#FFD780FF>Plunging Attack</color>\nPlunges from mid-air to strike the ground below, damaging opponents along the path and dealing AoE DMG upon impact.\n\n<color=#FFD780FF>In Praise of Shadows and the Masque of the Red Death</color>\nWhen Arlecchino has a Bond of Life equal to or greater than 20% of her Max HP, and her Normal, Charged, and Plunging Attacks will be converted to deal <color=#FF9999FF>Pyro DMG</color>. This cannot be overridden. \n When in the In Praise of Shadows state, Arlecchino's Normal Attacks will be converted to Masque of the Red Death: When she hits an opponent, this attack will deal extra DMG that is scaled off her ATK multiplied by her current Bond of Life percentage. This will consume 6.5% of said current Bond of Life. A Bond of Life can be consumed this way every 0.05s. When her Bond of Life is consumed in this manner, All is Ash's CD will decrease by 0.8s.",
