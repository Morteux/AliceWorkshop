const teams = {
    ...
    "127": {
        "name": "Neuvillette Dehya Hyperbloom",
        "description": "Dehya is surprisingly good with Neuvillette Hyperbloom. Low Pyro application to not steal hyperblooms, enough Pyro to trigger burning so Neuvillette can Vape and activate 3 stacks of his passive. On top of that, resistance interruption for the first Neuvillette CA so he can start to kite. However, Dehya reduces the amount of hyperbloom that you get by like 1/3.",
        "rotation": "Neuvillette E > Raiden/Kuki E > Nahida E Q > Dehya E > Neuvillette CA Q E CA > Dehya E > Neuvillette 2CA",
        "archetype": [
            "Hyperbloom"
        ],
        "viability": "Viable",
    ...
    "440": {
        "name": "Arlecchino Chevreuse",
        "description": "Good in output damage, but you don't have any type of defensive utility. Be careful with circle impact + overload with Bennett. <br><br>About Arlecchino's survability: She has pretty short rotations with flexible NA combos which allow you to dash a decent amount, a burst which should always overheal her and her A4. Since you can't get heal unlike others and in many teams you have 0 Interruption Resistance, you depends more on perfect dodgings than other characters. If you struggle against aggresive enemies like Coppelia, you might need defensive utility. Also, doing burst to heal will be the standard case, but if you manage to don't use it, you will have more damage, so I think that she is a good example of risk/reward.",
    ...
    "444": {
        ...
        "description": "Overall his best team DMG wise. Because of how frequently Neuvillette's HP is changing, he can generate a decent amount of Fanfare himself (~200 on avg, resulting in 50% DMG Bonus, can be slightly more with Prototype Amber) which makes Zhongli, because of his resistance shred and ability to use Archaic Petra, better than a healer, generally. Both Neuvillette & Furina benefit from Kazuha's and Zhongli's buffs, and although Furina doesn't have a great uptime on her passive which increases the DMG of the Salon Members by up to 140%, it's a team where she has one of the highest (or even the highest in longer rotations) personal DMG compared to other teams. <br> Energy Recharge requirements in this team are very low, Neuvillette is fine with 100%, Furina needs about 140%~, and you don't really need to use Kazuha's (and Zhongli's) Bursts. <br> <br> By Vomfee.",
        "rotation": "(28s) Neuvillette Skill > Furina Skill > Zhongli Skill (hold), (dash) > Furina Burst > Kazuha Skill/Burst > Neuvillette CA > Neuvillette Burst, Skill > Neuvillette CA > Kazuha Skill/Burst > Neuvillette CA, CA <br> <br> (30s) Can be slightly more DMG. Neuvillette Skill > Kazuha Skill, Burst > Furina Skill (dash), Burst > Zhongli Skill (hold), (dash) > Neuvillette CA > Neuvillette Skill > Neuvillette CA > Neuvillette Burst > Kazuha Skill > Neuvillette CA..",
        "archetype": [
            "Hypercarry"
        ],
        "viability": "Recommended",
    ...
    "448": {
        "name": "Arlecchino Chevreuse",
        "description": "With Xiangling, you gain in AoE, and with Yae Miko in singletarget though her rotations might me a little odd. <br><br>About Arlecchino's survability: She has pretty short rotations with flexible NA combos which allow you to dash a decent amount, a burst which should always overheal her and her A4. Since you can't get heal unlike others and in many teams you have 0 Interruption Resistance, you depends more on perfect dodgings than other characters. If you struggle against aggresive enemies like Coppelia, you might need defensive utility. Also, doing burst to heal will be the standard case, but if you manage to don't use it, you will have more damage, so I think that she is a good example of risk/reward.",
        "rotation": "",
        "archetype": [
            "Overload"
        ],
    ...
    "463": {
        ...
        "description": "Clasical National Team. Very strong and fun rotation. In this team, It is worth to have Xingqiu with Sacrificial sword, so you can do double E in the rotation (Do two instead one when it is said). If you time Xingqiu's E well, you would be able to get 2 vapes per E; if you don't, you will vape Xiangling Q so it's not a big loss. All the NA's that are shown in the rotation are just to wave Xingqiu's Burst, you want to cancel them. <br><br> This teams works with an special interaction between Guoba and Sucrose Swirl. You have to do Sucrose E when Guoba has the exclamation above him, and you will get a Pyro Swirl to apply VV, since Guoba imbues himself in Pyro in that moment. Thanks to Xingqiu's Burst, you would be able to get a double Swirl. ",
